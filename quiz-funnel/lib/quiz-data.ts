...
export const pathAQuestions: QuizQuestion[] = [
  ...
  createQuestion("Q4A", "A", quizContent.pathA.Q4A),
  createQuestion("Q5A", "A", quizContent.pathA.Q5A),
];
...
export const pathBQuestions: QuizQuestion[] = [
  ...
  createQuestion("Q4B", "B", quizContent.pathB.Q4B),
  createQuestion("Q5B", "B", quizContent.pathB.Q5B),
];
...
export const pathCQuestions: QuizQuestion[] = [
  ...
  createQuestion("Q4C", "C", quizContent.pathC.Q4C),
  createQuestion("Q5C", "C", quizContent.pathC.Q5C),
];
...
export const TOTAL_PATH_QUESTIONS = 5;
